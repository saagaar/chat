...
(function($){
    ...
    $.fn.rotapie = function (options) {
        ...
        wrapped.each(function () {
            ...
            var settings = $.extend({ 
                slices: [
                            { color: '#ff7200', percentage: 10 }, // If color not set, slice will be transparant.
                            { color: '#1569e7', percentage: 30 }, // Font color to render percentage defaults to 'color' but can be overriden by setting 'fontColor'.
                            { color: '#029e0a', percentage: 60 }
                        ],
                ...
                minRadius: 50, // Radius of unselected slices, can be set to percentage of container width i.e. '50%'
                maxRadius: 55, // Radius of selected slice, can be set to percentage of container width i.e. '45%'
                minInnerRadius: 27.5, // Smallest radius inner circle when animated, set to 0 to disable inner circle, can be set to percentage of container width i.e. '35%'
                maxInnerRadius: 32.5, // Normal radius inner circle, set to 0 to disable inner circle, can be set to percentage of container width i.e. '30%'
                innerColor: '#fff', // Background color inner circle. 
                minFontSize: 10, // Smallest fontsize percentage when animated, set to 0 to disable percentage display, can be set to percentage of container width i.e. '20%'
                maxFontSize: 15, // Normal fontsize percentage, set to 0 to disable percentage display, can be set to percentage of container width i.e. '10%'
        ...
        $(function(){
			...
			$('#pie01').rotapie({
                slices: [
                    { color: '#ff7200', percentage: 5 }, // If color not set, slice will be transparant.
                    { color: '#1569e7', percentage: 55 }, // Font color to render percentage defaults to 'color' but can be overriden by setting 'fontColor'.
                    { color: '#029e0a', percentage: 40 }
                ],
                sliceIndex: 0, // Start index selected slice.
                deltaAngle: 0.2, // The rotation angle in radians between frames, smaller number equals slower animation.
                minRadius: 50, // Radius of unselected slices, can be set to percentage of container width i.e. '50%'
                maxRadius: 55, // Radius of selected slice, can be set to percentage of container width i.e. '45%'
                minInnerRadius: 10, // Smallest radius inner circle when animated, set to 0 to disable inner circle, can be set to percentage of container width i.e. '35%'
                maxInnerRadius: 10, // Normal radius inner circle, set to 0 to disable inner circle, can be set to percentage of container width i.e. '30%'
                innerColor: '#fff', // Background color inner circle. 
                minFontSize: 8, // Smallest fontsize percentage when animated, set to 0 to disable percentage display, can be set to percentage of container width i.e. '20%'
                maxFontSize: 10, // Normal fontsize percentage, set to 0 to disable percentage display, can be set to percentage of container width i.e. '10%'
                fontYOffset: '0%', // Vertically offset the percentage display with this value, can be set to percentage of container width i.e. '-10%'
                fontFamily: 'Times New Roman', // FontFamily percentage display.
                fontWeight: 'bold', // FontWeight percentage display.
                decimalPoint: '.', // Can be set to comma or other symbol.
