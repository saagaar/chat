...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2017 at 04:55 AM
...
(1, 0, 'Lamas', 'Lamas is a quality focused IT company.', 168, 1, 1504123701, 0, 100, 100, '90000', '', 1, 'Kathmandu', '44600', 'Gyawali Marg', 'company@gmail.com', 1, '', '0123456789', 0, 0);
...
INSERT INTO `company_type` (`id`, `company_type`, `is_deleted`) VALUES
(1, 'test test', 0),
(2, 'test tested', 0),
(3, 'test again tested', 0),
(4, 'saad', 0);
...
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `email`, `phone`, `country_id`, `gender`, `dob`, `city`, `address`, `email_confirmed`, `status`, `registration_date`, `photo`, `company_id`, `login`, `password`, `delete_date`, `rate`, `work_hour`, `job_complete`, `earned`, `is_deleted`) VALUES
(1, 'Rabin', 'Lama', 'rrabin.llama@gmail.com', '9818798855', 168, 1, 750211200, 'Kathmandu', 'Old Baneshwor', 1, 1, 1504123701, '', 1, 'rrabin.llama@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 0, '10.0000', 30, 90, '9000.0000', 0);
...
INSERT INTO `services` (`id`, `company_id`, `title`, `description`, `price`, `count_sales`, `rate`, `is_deleted`) VALUES
(1, 1, 'web design', 'description on about web design.', '50', 55, '50', 0),
(2, 1, 'Hosting', 'Description on about hosting.', '45', 22, '45', 0);
