...
<head>
    ...
    <link href="http://weareoutman.github.io/clockpicker/dist/jquery-clockpicker.min.css" rel="stylesheet" type="text/css" media="all" />
                                            ...
                                            <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;width:520px;padding:0px;margin:auto;padding-bottom: 0;">
                                                ...
                                                <div class="single5" id="a4" style="display: block; margin-left: 3%; margin-right: 3%;">
                                                    ...
                                                    <div class="col-lg-12" style="border:1px solid #aab7a2;padding:0px;margin-top:10px;margin-bottom:15px">
                                                        ...
                                                        <script>
                                                            CKEDITOR.replace( 'editor1fefabc' );
                                                        </script>
                                                        <!-- <textarea class="form-control" placeholder="Text Editor and Text Box here to add the Desc." aria-describedby="basic-addon1" style="border-radius:0px;margin-bottom:0px;width:100%;border:none;font-family:OpenSans-Regular;height:102px;resize:none"></textarea> --></div>
                                                </div>
                                                <div class="single5" id="b4">
                                                    ...
                                                    <div class="col-lg-6" style="padding-top:10px;padding-bottom:10px;border-right:none;">
                                                        <div style="padding-left:30%">Post Start</div>
                                                        <div id="datetimepicker1" class="input-group date"> <input style="margin:0" class="form-control" type="text"> <span class="add-on input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                                    ...
                                                    <div class="col-lg-6" style="padding-top:10px;padding-bottom:10px;border-right:none; float:right">
                                                        ...
                                                        <div style="padding-left:30%">Post End</div>
                                                        <div id="datetimepicker2" class="input-group date"> <input style="margin:0" class="form-control" type="text"> <span class="add-on input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                                            <!-- <input data-format="dd/MM/yyyy" type="text" style="width:80%;"> <span class="add-on" style="padding-left:-4px;padding-right:25px;padding-top:4px;float:right"><i data-time-icon="icon-time" class="fa fa-calendar fa-2x"></i></span> --></div>
                                                        <script>
                                                            $(function() {
                                                    ...
                                                    <div>
                                                        <div class="col-lg-6"  style="width:33%;padding-top:10px;padding-bottom:10px;&nbsp;margin-bottom: 20px; border-right:none"> <select type="text" class="form-control"  placeholder="Ende Date" aria-describedby="basic-addon1" > <option>Full Time</option> <option>Part Time </option> <option selected="" disabled="">Work Type</option> </select> </div>
                                                        <div class="col-lg-6"  style="width:33%;padding-top:10px;padding-bottom:10px;"> <select type="text" class="form-control"  placeholder="Ende Date" aria-describedby="basic-addon1" > <option>Fix</option> <option>Hourly</option> <option selected="" disabled="">Payment Type</option> </select> </div>
                                                        <div class="col-lg-6"  style="width:33%;padding-top:10px;padding-bottom:10px;"> <select type="text" class="form-control"  placeholder="Ende Date" aria-describedby="basic-addon1" > <option>Now</option> <option>Agreement</option> <option selected="" disabled="">Work Start</option> </select> </div>
                                                    </div>
                                                </div>
                                                <div class="single5" id="c4">
                                                ...
                                                <div class="col-lg-12" style="margin-top:15px;&nbsp;margin-left: -12px; background-color:grey;"> <button type="button" class="back4" style="background-color: #6cb5f3;height: 100%;border:1px #6cb5f3 solid;width:200px;float: left;margin-left: -40px;">PREVIOUS</button>
                                                    ...
                                                    <ul class="div-link4">
                                                        <li class="active"><a href="#a4">A</a></li>
                                                        <li><a href="#b4">B</a></li>
                                                        <li><a href="#c4">C</a></li>
                                                    </ul><button type="button" class="next4" style="background-color: #6cb5f3;height: 100%;border:1px #6cb5f3 solid;width:200px;float: right;margin-right: -40px;">NEXT</button><button type="button" class="savebutton4" data-dismiss="modal" style="background-color: #6cb5f3;height: 100%;border:1px #6cb5f3 solid;width:200px;float: right;margin-right: -40px;">SAVE</button> </div>
                                            </div>
                                        </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
         ...
         <div class="logo">
           ...
           <div class="bhoechie-tab-content" style='width:70%' align='center'>
            <ul class="nav nav-tabs user-profile-menu nav-cust" role="tablist"align='center'>
                <li role="presentation" class="active">
                                        <a href="index.html#MatchedEmployeer" aria-controls="MatchedEmployeer" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-graduation-cap " aria-hidden="true" style="width:auto"></i> Matched Employeer </a>
                                    </li>
                                    <li role="presentation" class="">
                                        <a href="index.html#MyJobOffers" aria-controls="MyJobOffers" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-briefcase " aria-hidden="true" style="width:auto"></i> My Job Offers </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="index.html#WorkRequest" aria-controls="WorkRequest" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-hand-paper-o" aria-hidden="true" style="width:auto"></i> Work Request (Client/user) </a>
                                    </li>
        ...
        <div class="collapse navbar-collapse navbar-right" id="myNavbar">
          <ul class="nav navbar-nav">
               <li >
                        <button type="button" data-toggle="modal" data-target="#AddsearchMatchedEmployeer" class="btn btn-block btn-grey btn-xs aligncenter">+ | Add Search</button>
                </li>
            ...
            <div class="afix-content client-desh">
                        <div class="col-md-12 col-sm-12 col-xs-12 pull-left no-padding">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="MatchedEmployeer">
                                                        ...
                                                        <div class="">
                                                            <div class="col-lg-4">
                                                                <div class="ourteamdiver2">
                                                                    ...
                                                                    <hr class="rulermatchserc">
                                                                    <div data-toggle="modal" data-target="#MatchedEmployeerCoins" style="float:left;width:120px;display:block;margin-left:5%;margin-right:auto;margin-top:10px;" class="btn btn-primary">Contact Us</div>
                                                                    <div data-toggle="modal" data-target="#EmployeerCoinsButton" style="float:right;width:120px;display:block;margin-left:auto;margin-right:5%;margin-top:10px;" class="btn btn-danger">2 Coins</div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="ourteamdiver2">
                                    ...
                                    <div class="modal fade" id="EmployeerCoinsButton" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog" style="width:100%">
                                            <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none; width: 500px; padding:0; margin:auto;">
                                                <div style="border-top:10px solid #2db300;" class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                                                    <h4 class="modal-title custom_align text-center2" id="Heading">Pay with Coins</h4>
                                                </div>
                                                <div class="col-lg-8" style="padding:3%;width:100%;height:180px">
                                                    <table id="tableCoins" style="width: 100%">
                                                        <tbody>
                                                    ...
                                                    </table> <button data-dismiss="modal" type="button" class="btn btn-success " style="margin-left:32%;margin-top:18px;padding-bottom:10px; margin-bottom:20px;padding-left:5%;padding-right:5%;"> <span style="color: white; padding: 1px" class="fa fa-check-square-o fa-lg" aria-hidden="true"></span> Use The Coins</button> </div>
                                            </div>
                                        </div>
                                        <div id="ascrail2065" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: 495px; height: 0px; display: none;">
                                        ...
                                        <div id="ascrail2065-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
...
<div class="modal-content" tabindex="5" style="overflow: hidden; outline: none; width: 900px; padding:0; margin:auto;">
    ...
    $(this).addClass('pactive');
                                ...
                                <div role="tabpanel" class="tab-pane " id="MyJobOffers">
                                    <div class="vd_content-section clearfix">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="pdng20">
                                                    <div class="container-fluid">
                                                                        ...
                                                                        <table id="mytable" class="table table-bordred table-striped">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Edit" style="float:left;margin-right: 8px;"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#AddsearchMatchedEmployeer" style=" padding-left: 6px; padding-right: 19px;"><span class="glyphicon glyphicon-pencil"></span></button></p>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="View" style="float:left;margin-right: 8px;"><button class="btn btn-primary btn-xs" data-title="View" data-toggle="modal" data-target="#viewEmployeer" style=" padding-left: 0;padding-right: 19px;background-color: #23709e;border: none;padding-bottom: 8px;"><i class="fa fa-eye" aria-hidden="true"></i></button></p>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Delete" style="float:left"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete17" style=" padding-left: 6px; padding-right: 19px;"><span class="glyphicon glyphicon-trash"></span></button></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td></td>
                                                                                    ...
                                                                                    <td>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Edit" style="float:left;margin-right: 8px;"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#AddsearchMatchedEmployeer" style=" padding-left: 6px; padding-right: 19px;"><span class="glyphicon glyphicon-pencil"></span></button></p>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="View" style="float:left;margin-right: 8px;"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#viewEmployeer" style=" padding-left: 0;padding-right: 19px;background-color: #23709e;border: none;padding-bottom: 8px;"><i class="fa fa-eye" aria-hidden="true"></i></button></p>
                                                                                        <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Delete" style="float:left"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete17" style=" padding-left: 6px; padding-right: 19px;"><span class="glyphicon glyphicon-trash"></span></button></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                        ...
                                                        <div class="modal fade" id="view17" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;">
                                                                    ...
                                                                    <div class="modal-footer "> <button type="button" class="btn btn-warning btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>&nbsp;Update</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div id="ascrail2068" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;">
                                                                <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                                            </div>
                                                            <div id="ascrail2068-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
                                                                <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                                            </div>
                                                        </div>
                                                        <div class="modal fade" id="edit17" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;">
                                                                    <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                                                            ...
                                                            <div id="ascrail2069" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;">
                                                                <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                                            </div>
                                                            <div id="ascrail2069-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
                                                                <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                                            </div>
                                                        </div>
                                                        <div class="modal fade" id="delete17" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" tabindex="6" style="overflow: hidden; outline: none;">
                ...
                <div class="modal-footer" style=""> <button type="button" class="btn btn-success btn-primary mr-auto pull-left"><span class="glyphicon glyphicon-ok-sign"></span>Yes</button> <button type="button" class="btn btn-danger btn-secondary pull-right" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span>No</button> </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="WorkRequest">
                                                  
                                               <div class="vd_content-section" style="background-color:#f0f0f0;padding-top: 0px;">
                    
                    <div class="row">
                        <div class="col-lg-12">
                        <div class="pdng20">
                            <div class="panel widget container-fluid" style="background-color:#f0f0f0;padding:0;margin-top:25px">
                                
                                <!-- row start -->
                                <div class="row" style="padding:0;background-color:white;">
                                    
                                <a href="javascript:void(0);" title="">
                                      
                                        <div class="col-sm-2" style="width:13%;padding:0;border-left: 5px blue solid;height: 116px;">
                                        <img style="height:116px;" src="<?php echo base_url('assets/'); ?>img/testi_03.png" alt="">
                                        </div>
                                        <div class="col-sm-2" style="padding-left:3px;width:21%;">
                                             <h4 class="mrgn0" style=" padding-top:27%">User Name User ID</h4>
                                              
                                    </div>
                                    <div class="col-sm-3 brdLeft" style="padding:0%;height: 116px;width:19%">
                                        <h4 class="text-center2" style="">Request Time</h4>
                                        <div class="NewAppionemtstitle">12.03.2017 17:30</div>
                                    </div>
                                    <div class="col-sm-3  brdLeft" style="padding:0%;height: 116px;width:27%">    
                                        <h4 class="text-center2" style="">Work Start/Type</h4>
                                        <div class="NewAppionemtstitle">Date / Agreement</div>
                                        <div class="NewAppionemtstitle" style="margin-top: 7px;">Full Time/ Part Time</div>
                                    </div>
                                    
                                    <div class="col-sm-2 brdLeft" style="padding:0;height: 116px;width:20%">
                                        <h4 class="text-center2" style=" ">Status</h4>
                                        <h3 class="text-center2" style="color:blue">Waiting</h3>
                                ...
                                <!-- row start -->
                                <div class="row" style="padding:0;background-color:white;margin-top:22px"data-toggle="modal" data-target="#notifydenied">
                                    
                                <a href="javascript:void(0);" title="">
                                      
                                        <div class="col-sm-2" style="width:13%;padding:0;border-left: 5px red solid;height: 116px;">
                                        <img style="height:116px;" src="<?php echo base_url('assets/'); ?>img/testi_03.png" alt="">
                                        </div>
                                        <div class="col-sm-2" style="padding-left:3px;width:21%;">
                                             <h4 class="mrgn0" style=" padding-top:27%">User Name User ID</h4>
                                    ...
                                    <div class="col-sm-2 brdLeft" style="padding:0;height: 116px;width:20%">
                                        <h4 class="text-center2" style=" ">Status</h4>
                                        <h3 class="text-center2" style="color:red"  >Denied</h3>
    ...
    <div id="ascrail2009" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2009-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2011" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2011-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2021" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2021-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2028" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2028-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2051" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2051-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div>
                                ...
                                <!-- row start -->
                                <div class="row" style="padding:0;background-color:white;margin-top:22px">
                                    
                                <a href="javascript:void(0);" title="">
                                      
                                        <div class="col-sm-2" style="width:13%;padding:0;border-left: 5px green solid;height: 116px;">
                                        <img style="height:116px;" src="<?php echo base_url('assets/'); ?>img/testi_03.png" alt="">
                                        </div>
                                        <div class="col-sm-2" style="padding-left:3px;width:21%;">
                                             <h4 class="mrgn0" style=" padding-top:27%">User Name User ID</h4>
                                    ...
                                    <div class="col-sm-2 brdLeft" style="padding:0;height: 116px;width:20%">
                                        <h4 class="text-center2" style=" ">Status</h4>
                                        <h3 class="text-center2" style="color:green">Accepted</h3>
                                        <button data-toggle="modal" data-target="#MyJobenquireuserworkrequest" class="btn btn-success" style="margin-left: 19%; margin-top: -3%;">Document 5</button>
                                    ...
                                    <div class="modal fade " id="MyJobenquireuserworkrequest" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="padding-left: 17px;display: none;">
      <div class="modal-dialog" style="width: 820px;">
    <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;padding:7px">
          <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title custom_align text-center2" id="Heading">View Documents</h4>
      </div>
        <div class="col-lg-12">
        <div class="col-lg-4">
            <img src="<?php echo base_url('assets/'); ?>img/testi_03.png" alt="" class="projectImgfordocumnet" >
            <h4 class="mrgn0" style=" padding-top:13%;padding-left: 14%;">User Name</h4>
            <h4 class="mrgn0" style=" padding-left: 14%;">User ID</h4>
            </div>
        <div class="col-lg-8" style="border-left:1px solid #d5d2d2;margin-top: 14px;">
             <div class="col-md-4 col-sm-4 padding15" style="margin-bottom: 29px;">
                                <div class="uploaded-img">
                                    <a href="">
                                    <img src="<?php echo base_url('assets/'); ?>https://infograins.com/INFODE/pankaj/dj/inner-box.png">
                                    <div class="immer-img">
                                        <img src="<?php echo base_url('assets/'); ?>https://infograins.com/INFODE/pankaj/dj/box.png">
                                    </div>
                                    ...
                                    <div class="abslt-text">
                                        <h4 class="marginbottom0document">Document Name</h4>
                                        <p>Sub Title</p>
        ...
        <div class="col-lg-3 col-lg-offset-3 "><button type="button" class="btn vd_btn " data-toggle="modal" data-target="#StatusWaitinginterviewuser2" data-dismiss="modal" style="text-align: left;
    width: 100%;
    padding: 4px;
    border-radius: 24px;
    color: black;
...
">
            <span class="append-icon" style="text-align:left;margin-right:42"><img src="<?php echo base_url('assets/'); ?>img/true.png" style="width:23px;margin-right: 31px;"></span>Interview</button></div>
              <div class="col-lg-3 ">
                 
                  <button type="button" class="btn vd_btn "  data-toggle="modal" data-target="#DeniedWorkReq" data-dismiss="modal" style="text-align: left;
    width: 100%;
    padding: 4px;
    border-radius: 24px;
    color: black;
...
">
            <span class="append-icon" style="text-align:left;margin-right:42"><img src="<?php echo base_url('assets/'); ?>img/false.png" style="width:23px;margin-right: 31px;"></span>Reject</button>
    ...
    <!-- /.modal-content --> 
      ...
      <!-- /.modal-dialog --> 
    <div id="ascrail2008" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2008-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; left: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2010" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2010-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; left: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2020" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2020-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2007" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2007-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2016" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2016-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div></div><div id="ascrail2049" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2049-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div></div></div>                            
                                            
               <div class="modal fade  " id="StatusWaitinginterviewuser2" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="padding-left: 17px; display: none;">
      <div class="modal-dialog">
    <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;padding:7px">
          <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title custom_align text-center2" id="Heading">Interview</h4>
      </div>
         
        
       
        <div class="col-lg-6" style="padding-top:10px;padding-bottom:10px;border-right:none;">
                                                            <div style="padding-left:30%">Select Date</div>
         ...
         <div class="col-lg-6" style="padding-top:10px;padding-bottom:10px;border-right:none; float:right">
    <!--    <input type="text" class="form-control" placeholder="Post Start" aria-describedby="basic-addon1" style="border-radius:0px;margin-bottom:0px;width:100%;border:none;font-family:OpenSans-Regular;padding-right: 16px;">  -->
     <script> $(function() {
  ...
  $('#datetimepicker3').on('changeDate', function(ev){
    $(this).datetimepicker('hide');
     ...
     <div style="padding-left:30%">Select Time</div>
            <div class="container">
            <div id="input-a" class="input-group date">
                                                            <input style="margin:0" type='text' class="form-control" id="input-a" value="" data-default="20:48" />
                                                            <span class="add-on input-group-addon">
...
">
            <span class="append-icon" style="text-align:left;margin-right:42"><img src="<?php echo base_url('assets/'); ?>img/send.png" style="width:23px;margin-right: 31px;"></span>Sent</button></div>
    ...
    <!-- /.modal-content --> 
      ...
      <!-- /.modal-dialog --> 
    <div id="ascrail2008" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2008-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; left: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2010" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2010-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; left: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2020" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2020-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2007" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2007-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2016" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2016-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div></div><div id="ascrail2045" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2045-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div></div><div id="ascrail2054" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 1;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2054-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 1;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div></div></div>       
                                                          
                                        
                                    <div id="DeniedWorkReq" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="padding-left: 17px; display: none;">
                                        <div class="modal-dialog">
...
">
                                                            <span class="append-icon" style="text-align:left;margin-right:42"><img src="<?php echo base_url('assets/'); ?>img/send.png" style="width:23px;margin-right: 10px;"></span>Send</button>
                                                    </div>
                                                </div>
                                            </div>

                                        </div>
                                    <div id="ascrail2013" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;"></div></div><div id="ascrail2013-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; left: 0px;"></div></div></div>
                        ...
                        <div class="modal fade" id="AddsearchMatchedEmployeer" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;">
                                        ...
                                        <div id="ascrail2029" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: 515px; height: 16px; display: none; opacity: 1;">
                                            <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                        </div>
                                        <div id="ascrail2029-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: 11px; left: 0px; position: absolute; cursor: default; display: none; opacity: 1;">
                                            <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px; left: 0px;"></div>
                                        </div>
                                        <div id="ascrail2067" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: 515px; height: 0px; display: none;">
                                            <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                        </div>
                                        <div id="ascrail2067-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
                                            <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                                        </div>
                                    </div>    
                            
                            
                        <div class="modal fade" id="viewEmployeer" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog" style="width:100%">
                                            <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;width:350px;padding:0px;margin:auto;padding-bottom: 0;">
                                                <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                                                    <h4 class="modal-title custom_align text-center2" id="Heading">Search Emplyeer</h4>
                                                </div>
                                                <div class="ourteamdiver2">
