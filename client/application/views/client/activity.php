            ...
            <div class="top-nav notification-row">
              <ul class="nav pull-right top-menu set-bs-menu">
                <li class='post-job' style="margin-top:5px">
                  ...
                  <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#"> <span class="username">Jenifer Smith</span><span class="profile-ava"> <img alt="" src="img/avatar1_small.jpg"> </span><b class="caret"></b> </a>
            ...
            <div class="top-nav notification-row">
              <ul class="nav pull-right top-menu set-bs-menu">
                <li class='post-job' style="margin-top:8px;">
                  ...
                  <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#"> <span class="username hidden-sm hidden-md">Jenifer Smith</span><span class="profile-ava"> <img alt="" src="img/avatar1_small.jpg"> </span><b class="caret"></b> </a>
                  <ul class="dropdown-menu extended logout">
                    <div class="log-arrow-up"></div>
                    <li class="eborder-top"> <a href="index.html#"><i class="fa fa-user-o"></i>My Profile</a> </li>
                    <li> <a href="index.html#"><i class="fa fa-gear"></i> Settings</a> </li>
                    ...
                    <div class="row" style="padding: 15px; background-color: #f3f3f3">
                        ...
                        <div class="col-lg-4 text-center" style="    padding: 0px 15px;" >
                           ...
                           <div class="col-lg-12 profile-bc">
                               ...
                               <img class="profile-pic" src="img/avatar/bobbyjkane.jpg">
                               </div>
    ...
    <div class="modal-content" tabindex="6" style="overflow: hidden; outline: none;">
       ...
       <div style="text-align: center; color:black;">New Offer Sent<br>Please wait for Response</div>
        ...
        <div class="modal-footer text-center2">
            ...
            <span class="append-icon" style="text-align:left;margin-right:42"><img src="img/true.png" style="width:23px;margin-right: 31px;"></span>OK</button>
