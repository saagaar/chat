...
<head>
    ...
    <script src="<?php echo base_url('assets/'); ?>js/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
    ...
    <script src="<?php echo base_url('assets/'); ?>js/pages/sale_services.js"></script>
           ...
           <div class=" collapse navbar-collapse " id="new-nav">
              ...
              <ul class="nav  navbar-nav  nav-resp" role="tablist" style="float:none">
               ...
               <ul class="nav navbar-nav navbar-right">
                    <li >
                        <button type="button" id="add_new_service" data-toggle="modal" data-target="#bestselleraddnewservice" class="btn btn-block btn-grey btn-xs aligncenter"> + | Add New Service</button>
                    </li>
                                                    ...
                                                    <div class="pdng20">
                                                        <div class="container-fluid">
                                                            <div class="container loaded">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <input type="hidden" name="ajax_url" class="ajax_url" value="<?php echo $ajax_url; ?>">
                                                                        <div class="table-responsive list_sale_services">
                                                                            <!-- data is displayed here via ajax call -->
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" tabindex="6" style="overflow: hidden; outline: none;">
                                                                                ...
                                                                                <div class="modal-footer ">
                                                                                    <a href="" id="service_delete_confirm" class="btn btn-success"><span class="glyphicon glyphicon-ok-sign"></span>&nbsp;Yes</a>
                                                    ...
                                                    <div class="pdng20">
                                                        <div class="container-fluid">
                                                            <div class="container loaded">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <input type="hidden" name="ajax_url2" class="ajax_url2" value="<?php echo $ajax_url2; ?>">
                                                                        <div class="table-responsive manage_sale_services">
                                                                            <!-- data is displayed here via ajax call -->
                                                                        </div>
                                                                    </div>
                                                                </div>
...
-->
        <div class="modal right fade in" id="viewAccept" tabindex="-1" role="dialog" aria-labelledby="Add maincategory" aria-hidden="false" style="z-index: 1042; display: none;">
            <!-- Fetch service data here via ajax -->
        </div>
    </div>
                                                    ...
                                                    <div class="pdng20">
                                                        <div class="container-fluid">
                                                            <div class="container loaded">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <input type="hidden" name="ajax_url3" class="ajax_url3" value="<?php echo $ajax_url3; ?>">
                                                                        <div class="table-responsive sale_services_history">
                                                                            <!-- data is displayed here via ajax call -->
                                                                        </div>
                                                                    </div>
                                                                </div>
 ...
 <div class="modal right fade in" id="viewAccept2" tabindex="-1" role="dialog" aria-labelledby="Add maincategory" aria-hidden="false" style="z-index: 1042; display: none;">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
        ...
        <div class="modal-dialog">
            <div class="modal-content" tabindex="6" style="overflow: hidden; outline: none;">
                ...
                <div class="modal-footer" style="">
                    <a href="" id="service_delete_confirm2" class="btn btn-success btn-primary mr-auto pull-left"><span class="glyphicon glyphicon-ok-sign"></span>Yes</a>
                    <button type="button" class="btn btn-danger btn-secondary pull-right" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span>No</button> </div>
            </div>
            <script>
