        ...
        <tr>
            ...
            <td>
                <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Edit" style="float:left;margin-right: 8px;">
                    <button class="btn btn-primary btn-xs" id="edit_service" data-title="Edit" data-toggle="modal" data-target="#bestselleraddnewservice" data-service_id="<?php echo $val->id; ?>" style=" padding-left: 6px; padding-right: 19px;">
                        <span class="glyphicon glyphicon-pencil"></span>
                    </button>
                </p>

                <p data-placement="top" data-toggle="tooltip" title="" data-original-title="Edit" style="float:left;margin-right: 8px;">
                    <button class="btn btn-primary btn-xs" id="view_service" data-title="Edit" data-toggle="modal" data-target="#viewAccept" data-service_id="<?php echo $val->id; ?>" style=" padding-left: 0;padding-right: 19px;background-color: #23709e;border: none;padding-bottom: 8px;">
