				...
				<a id="loadmorechat" style="text-align:center; cursor: pointer">Load More..</a>
					...
					{
						$pp=USER_PROFILE_PICTURE_PATH.$profilePicture_user;
						$chatattachment=USER_CHAT_ATTACHMENT_PATH;
					}
					else
					{
						$pp=CLIENT_PROFILE_PICTURE_PATH.$loggeduser.'/'.$profilePicture;
...
<script type="text/javascript">
	var user_profile_picture_url='<?php echo USER_PROFILE_PICTURE_PATH.$profilePicture_user?>';
	var client_profile_picture_url='<?php echo CLIENT_PROFILE_PICTURE_PATH.$loggeduser.'/'.$profilePicture;?>';
</script>