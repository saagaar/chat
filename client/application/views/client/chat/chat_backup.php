...
<head>
	...
	<!-- <link href="<?php echo base_url('assets/'); ?>css/flag-icon.min.css" media="screen" rel="stylesheet" type="text/css">
...
<body>
	<?php $this->load->view('client/shared/chat-header');?>
	<div class="wrapper">
		<div class="container">
										...
										<div class="row">
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="fixed-left">
													<div class="new-chat">
														<div class="avatar">
															<img src="<?=base_url('assets/user/')?>img/coreyweb.jpg" alt="...">
													...
													<div class="bhoechie-tab-content">
														<div>
															<ul class="nav nav-tabs mainnav" role="tablist">
																...
																<li role="presentation"><a aria-controls="chatHistory" class="chatHistoryTab"  data-toggle="tab" href="index.html#chatHistory" role="tab"><i class="fa fa-comments-o" aria-hidden="true"></i> Chat History</a></li>
															</ul>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="fixed-right">
													...
													<div class="form-group searching-box ">
														...
														<input type="text" class="form-control filterdocumentname" placeholder="Search Documents">
														
														<!-- <span class="glyphicon glyphicon-search search-document searchoptbtn" aria-hidden="true"></span> -->
														<button class="btn btn-pink filteroptname"  data-searchurl="<?php echo base_url().'index.php/message/search_document'?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>
														</button>
													</div>
													</form>
													<div class="searching-box-type">
														<ul>
															<li >
																...
																<a href="#" class="filteroptname documenttype" data-filetype="docx" data-searchurl="<?php echo base_url().'index.php/message/search_document'?>"  data-toggle="tab">
																	<i class="fa fa-file-word-o" aria-hidden="true"></i>
																</a>
															</li>
															<li>
																<a href="#" class="filteroptname documenttype" data-filetype="img" data-searchurl="<?php echo base_url().'index.php/message/search_document'?>"  data-toggle="tab">
																	<i class="fa fa-picture-o" aria-hidden="true"></i>
																</a>
															</li>
															<li>
															<a href="#" class="filteroptname documenttype" data-searchurl="<?php echo base_url().'index.php/message/search_document'?>" data-filetype="all" data-toggle="tab">
														...
														<div class="tab-content">
																<div class="tab-pane active" id="tab_default_1">
																	...
																	<div class="padding10">
																		...
																		<?php foreach($documentlist as $eachdocument):?>
																		<div class="media">
																		  <div class="pull-left">
																		    <a href="#">
																		  ...
																		  <div class="media-body">
																		    <h4 class="media-heading">
																		     <a href="<?php echo base_url();?>assets/upload/<?php echo $eachdocument->url;?> download" download>
	...
	var chatroom=$("#chatroomid").val();
        ...
        var conn = new ab.Session('ws://127.0.0.1:8081',
		        ...
		        {'skipSubprotocolCheck': true}
															...
															<li class="company">
																<div class="avatar">
																	<img src="<?php echo base_url('assets/'); ?>img/ashi.jpg" alt="...">
																	<span class="online">●</span>
																</div>
																<div class="details">
																	<h5>Company Name</h5>
																									...
																									<div class="bhoechie-tab-content active">
																										<div>
																											<ul class="nav nav-tabs subnav" role="tablist">
																												<li class="" role="presentation"><a aria-controls="" aria-expanded="false" data-toggle="tab" href="index.html#myprofile" role="tab"><i aria-hidden="true" class="fa fa-briefcase"></i>Current Job</a></li>
																												<li class="" role="presentation"><a aria-controls="" aria-expanded="false" data-toggle="tab" href="index.html#payment" role="tab"><i aria-hidden="true" class="fa fa-pencil-square-o"></i>Current Contracts</a></li>
																												<li class="" role="presentation"><div class="wrapper">
		<div class="container">
			<div class="desh-content">
				<div class="row">
					<div class="afix-content client-desh">
