      ...
      <div class="container-fluid">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#new-nav">
            ...
            <a href="index.html" class="navbar-brand"> <img src="img/header/logo.png" /> </a>
           ...
           <div class=" collapse navbar-collapse " id="new-nav">
              ...
              <ul class="nav  navbar-nav  nav-resp" role="tablist" style="float:none">
                  <li role="presentation" class="active">
                      <a href="index.html#NewAppionemts" aria-controls="NewAppionemts" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-calendar-plus-o" aria-hidden="true" style="width:auto"></i> New&nbsp;Appionemts </a>
                    </li>
                    <li role="presentation" class="">
                      <a href="index.html#AcceptedAppionemts" aria-controls="AcceptedAppionemts" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-calendar-check-o " aria-hidden="true" style="width:auto"></i> Accepted&nbsp;Appionemts </a>
                    </li>
                    <li role="presentation" class="">
                      <a href="index.html#DeniedAppionemts" aria-controls="DeniedAppionemts" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-calendar-times-o" aria-hidden="true" style="width:auto"></i> Denied&nbsp;Appionemts </a>
                    </li>
                <li role="presentation">
                    <a href="index.html#Interviews" aria-controls="Interviews" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-coffee " aria-hidden="true"style="width:auto"></i> Interviews </a>
                </li>
  ...
  <div class="wrapper">
    ...
    <div class="afix-content client-desh">
            <div class="col-md-12 col-sm-12 col-xs-12 pull-left no-padding">
              ...
              <div class="border-box border-blue custom-page-content" style="border-width: 0;">
                
                
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="NewAppionemts">
                    <div class="vd_content-section clearfix" style="padding:0">
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="pdng20">
                            <div class="" style="padding-left: 20px;padding-top:20px">
                              <div class="row mrgn30-0 projectRow" style="margin: 0;padding: 0;">
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#NewAppionemtspop" title="">
                                  <div class="col-sm-3 brdRight" style="padding-left: 0;">
                                  ...
                                  <div class="col-sm-3 brdRight" style="width:21%; height: 110px;">
                                    ...
                                    <p class="mrgn5"><span class="label label-default vd_bg-red vd_white">Notification</span></p>
                                  </div>
                                  <div class="col-sm-2 " style=" height: 110px;">
                                    <h4>Status</h4>
                                    <div class="">
                                      <div class="">
                  ...
                  <div role="tabpanel" class="tab-pane " id="AcceptedAppionemts">
                    <div class="vd_content-section clearfix" style="padding:0">
                      <div class="row">
                        <div class="col-lg-12">
                        <div class="pdng20">
...
">
                                ...
                                <div class="row mrgn30-0 projectRow" style="
    margin: 0;
    padding: 0;
">
...
">
                                    ...
                                    <div class="col-sm-2 brdRight" style=" height: 110px;">
                                        ...
                                        <div class="col-sm-2 brdRight" style=" height: 110px;">
                                        <h4>Date Appointment</h4>
                                        <p class="mrgn5">05-07-2017 12:05:00</p>
                                        
                                    </div>
                                    
                                    <div class="col-sm-2 brdRight" style="width:14%; height: 110px;">
                                        <h4>Appointment Notifications</h4>
                                        <p class="mrgn5"><span class="label label-default vd_bg-red vd_white">Notification</span></p>
                                    </div>
                                     <div class="col-sm-2 brdRight" style=" height: 110px;">
            ...
            <div class="">
                <div class="letter-holder">
                    <div class="l-1 letter letter2">A</div>
                    <div class="l-2 letter letter2">c</div>
                    <div class="l-3 letter letter2">c</div>
                    <div class="l-4 letter letter2">e</div>                   
                    <div class="l-5 letter letter2">p</div>                   
                    <div class="l-6 letter letter2">t</div>                   
                    <div class="l-7 letter letter2">e</div>                   
                    <div class="l-8 letter letter2">d</div>
                                         ...
                                         <div class="col-sm-1 " style=" height: 110px;width: 11%;">
                                        <h4>Options</h4>
                                             <p class="mrgn5" data-toggle="modal" data-target="#EncashtheServices" style="margin-bottom: 14px;    margin-top: 20px;"><span class="label label-default vd_white" style="padding:6px 15px 6px 13px;font-size:14px;font-family: monospace;    border-radius: 4px !important;background:rgba(151, 190, 46, 0.72);">Encash</span></p>
                  ...
                  <div role="tabpanel" class="tab-pane" id="DeniedAppionemts">
                    <div class="vd_content-section clearfix" style="padding:0">
                      <div class="row">
                        <div class="col-lg-12">
                        <div class="pdng20">
...
">
            ...
            <div class="">
                <div class="letter-holder">
                    <div class="l-1 letter letter2">D</div>
                    <div class="l-2 letter letter2">e</div>
                    <div class="l-3 letter letter2">n</div>
                    <div class="l-4 letter letter2">i</div>
                    <div class="l-5 letter letter2">e</div>
                    <div class="l-6 letter letter2">d</div>
        ...
        <div class="ourteamdiver2" style="float:left;margin-top:0px; width:32%;margin-right:1%;border-top: green 7px solid;background-color: white;">
                ...
                <div class="modal fade" id="notificPop" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
      <div class="modal-dialog">
    <div class="modal-content" tabindex="6" style="overflow: hidden; outline: none;">
          <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title text-center2" id="Heading">Notifications</h4>
      </div>
    ...
    <div id="ascrail2009" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2009-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2011" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2011-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2021" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2021-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(154, 192, 52); background-clip: padding-box;"></div></div><div id="ascrail2028" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2028-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2051" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2051-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div>
                  ...
                  <div class="modal fade " id="InfoNewAppionemtspop" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;padding-left: 17px;">
                    <div class="modal-dialog">
                      <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;padding:7px">
                        <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                          <h4 class="modal-title custom_align text-center2" id="Heading">Info</h4>
                        </div>
                        <h4 class="text-center2" style="width: 60%;margin: 15px auto;">Thanks for Accepted User has Been Informed </h4>
                    ...
                    <div id="ascrail2057" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;">
                      <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                    </div>
                    <div id="ascrail2057-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
                      <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                    </div>
                  </div>
             <!--     <div class="modal fade " id="NewAppionemtspop" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none;padding-left: 17px;">
                    <div class="modal-dialog">
                      <div class="modal-content" tabindex="5" style="display: table-row-group;padding:0px;">
                        <div class="modal-header" style="border-top: 5px solid red;margin-bottom:6%"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                        ...
                        <div class="col-lg-12" style="margin-top:5px;margin-bottom:3%;">
                          <div class="col-lg-6 col-lg-offset-3"><button type="button" class="btn vd_btn " data-dismiss="modal" style="text-align: left; width: 100%; padding: 4px; border-radius: 24px; color: black; background: white; border: 1px solid #cbcbcb;"> <span class="append-icon" style="text-align:left;margin-right:42"><img src="img/send.png" style="width:23px;margin-right: 31px;"></span>Sent</button></div>
                        </div>
                      </div>
                    </div>
                    <div id="ascrail2008" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none; opacity: 0;">
                    ...
                    <div id="ascrail2058" class="nicescroll-rails" style="width: 5px; z-index: 1050; cursor: default; position: absolute; top: 0px; left: -5px; height: 0px; display: none;">
                      <div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                    </div>
                    <div id="ascrail2058-hr" class="nicescroll-rails" style="height: 5px; z-index: 1050; top: -5px; left: 0px; position: absolute; cursor: default; display: none;">
                      <div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(154, 192, 52); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
                    </div>
                  </div>
-->
                ...
                <div class="modal fade " id="NewAppionemtspop" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" style="display: none; padding-left: 19px;">
                    <div class="modal-dialog">
                        <div class="modal-content" tabindex="5" style="overflow: hidden; outline: none;padding:7px">
                            <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                                <h4 class="modal-title custom_align text-center2" id="Heading">Encash the Services</h4>
                            </div>
                            ...
                            <div class="col-lg-12" style="border:1px solid #aab7a2; margin-bottom: 8px;"><input class="form-control" placeholder="Purchase Code" aria-describedby="basic-addon1" style="border-radius:0px;margin-bottom:0px;width:100%;border:none;font-family:OpenSans-Regular;padding-left: 22px;text-align-last:center"
                                                                                                                type="text"> <img src="<?php echo base_url('assets/'); ?>img/code.png" class="calimgaeleft"> </div>
                            <div class="col-lg-12" style="padding:0px;">
                                <div class="payementnotification" style="padding:5px 0px;margin-bottom:10px">
                                    <h4 class="text-center2" style="font-family: 'Poppins', sans-serif">Notification</h4>
                                </div>
                            </div>
                            <hr class="hfkaniei">
                            <div class="col-lg-12" style="margin-top:5px;margin-bottom:8px;">
                                <div class="col-lg-6 "><button type="button" class="btn vd_btn " data-dismiss="modal" style="text-align: left; width: 100%; padding: 4px; border-radius: 24px; color: black; background: white; border: 1px solid #cbcbcb;"> <span class="append-icon" style="text-align:left;margin-right:42px"><img src="<?php echo base_url('assets/'); ?>img/true.png" style="width:23px;margin-right: 31px;"></span>Encash</button></div>
                                <div class="col-lg-6 "> <button type="button" class="btn vd_btn " data-dismiss="modal" style="text-align: left; width: 100%; padding: 4px; border-radius: 24px; color: black; background: white; border: 1px solid #cbcbcb;"> <span class="append-icon" style="text-align:left;margin-right:42px"><img src="<?php echo base_url('assets/'); ?>img/false.png" style="width:23px;margin-right: 31px;"></span>Denied</button>                                </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-body h100">
          ...
          <div class="row">
            <div class="col-lg-2 text-center">
              <div class="userAvatar vd_bg-light-grey"> <img src="img/testi_06.png" class="img-responsive"> </div>
                  ...
                  <div class="borderpopmohamed">
                    <div class="row mrgn15-0 projectRow vd_bg-light-grey vd_bdl-green brdl4">
                      ...
                      <div class="col-sm-3 pdng5-0 text-center">
                        <a data-toggle="modal" data-target="#showFile" href="javascript:void(0);"><img src="img/svg.png" alt="" width="25" height="80"></a>
                      </div>
                      <div class="col-sm-9">
                    ...
                    <div class="row mrgn15-0 projectRow vd_bg-light-grey vd_bdl-green brdl4">
                      ...
                      <div class="col-sm-3 pdng5-0 text-center">
                        <a data-toggle="modal" data-target="#showFile" href="javascript:void(0);"><img src="img/ppt.png" alt="" width="25" height="80"></a>
                      </div>
                      <div class="col-sm-9">
                        <div class="col-sm-3">06_plan.jpg</div>
                        <div class="col-sm-3"><i class="icon-user"></i> Vint Cerf</div>
                    ...
                    <div class="row mrgn15-0 projectRow vd_bg-light-grey vd_bdl-green brdl4">
                      ...
                      <div class="col-sm-3 pdng5-0 text-center">
                        <a data-toggle="modal" data-target="#showFile" href="javascript:void(0);"><img src="img/png.png" alt="" width="25" height="80"></a>
                      </div>
                      <div class="col-sm-9">
                        <div class="col-sm-3">06_plan.jpg</div>
                        <div class="col-sm-3"><i class="icon-user"></i> Vint Cerf</div>
                    ...
                    <div class="col-lg-12" style="">
                      <div class="row projectRow vd_bg-light-grey vd_bdl-red brdl4">
                        <div class="col-sm-12 pdng5-0">
                          ...
                          <div class="col-sm-1 col-sm-offset-6"><img src="img/falseblack.png" style="width:22px;"></div>
                          <div class="col-sm-1"><img src="img/trueblack.png" style="width:22px;"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12" style="">
                      <div class="row projectRow vd_bg-light-grey vd_bdl-green brdl4">
                        <div class="col-sm-12 pdng5-0">
                          ...
                          <div class="col-sm-1 col-sm-offset-6"><img src="img/delete.png" style="width:22px;"></div>
                          <div class="col-sm-1"><img src="img/edit.png" style="width:22px;"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-4" style="">
                      <div class="row projectRow vd_bg-light-grey vd_bdl-red brdl4">
                        <div class="col-sm-12 pdng5-0">
                          ...
                          <div class="col-sm-2 " style="padding:0px"><img src="img/falseblack.png" style="width:22px;"></div>
                          <div class="col-sm-2 col-sm-2 col-sm-offset-1" style="padding:0px"><img src="img/trueblack.png" style="width:22px;"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4" style="">
                      <div class="row projectRow vd_bg-light-grey vd_bdl-green brdl4">
                        <div class="col-sm-12 pdng5-0">
                          ...
                          <div class="col-sm-2 " style="padding:0px"><img src="img/delete.png" style="width:22px;"></div>
                          <div class="col-sm-2 col-sm-2 col-sm-offset-1" style="padding:0px"><img src="img/edit.png" style="width:22px;"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
