<?php $this->load->view('chat/chat_header');?>
<div class="wrapper">
<div class="container">
										...
										<div class="tab-content">
												<div class="tab-pane active" id="tab_default_1">
													...
													<div class="padding10">
														...
														<?php 
														// print_r($documentlist);exit;
														if(!isset($documentlist['error_message'])):
														...
														<div class="media">
														  ...
														  <div class="media-body">
														    ...
														    <?php echo str_pad(substr($eachdocument->url, 0,15), 18,'..')?> 
														    </a>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="fixed-right">
		<div class="new-chat">
			<div class="avatar">
				<img src="<?= USER_PROFILE_PICTURE_PATH.'/'.$profilePicture;?>" alt="profile picture">
	...
	<div class="allcontentuser">
			<?php 
			if(!isset($allchatroom['error_message'])):
			...
			?>
				...
				foreach ($value as $eachvalue):
					...
					$image=$eachvalue->profile_picture;
				...
				<li style="cursor:pointer" data-url="<?php echo CHAT_MODULE.'ajax_chat_history' ?>" class="company jobmsglisting <?php if($chatroomid==$eachvalue->roomid) echo 'active';?>" data-roomid="<?php echo $eachvalue->roomid;?>" >
						<div class="avatar">
							<img src="<?=COMPANY_PROFILE_PICTURE.'/'.$eachvalue->profile_picture;?>" alt="Profile picture">
							<span class="online">●</span>
						</div>
						<div class="details">
						...
						<div class="notifications-dropdown">
							...
							<div class="dropdown-menu notifications-tabs">
								<ul>
									<li>
										<a href="#"><i class="fa fa-lock" aria-hidden="true"></i> Block</a>
									</li>
									<li>
										<a href="#"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Report</a>
									</li>
									<li>
										<a href="#"><i class="fa fa-heart" aria-hidden="true"></i> Favourite</a>
									</li>
								</ul>
							</div>
						</div>
